const dataText = ["47 Tucanae,0,24,-72,5,13000,,GC,30 thousand stars with a dense core which may contain a black hole. Second brightest globular cluster. Not part of the LMC. 12 myo.",
  ...
  "Alpha  Crucis    Acrux,12,26,-63,6,320,0.77,DS,1.3 and 1.6 separated 4 seconds",
  "Gamma  Crucis    Gacrux,12,31,-57,7,87,1.6,DS,1.8 and 6.5 separated 125 seconds",
  ...
  "Alpha Centauri    Rigil Kentaurus,14,39,-60,50,4,-0.01,DS,0.0 and 1.4 separated 13 seconds",
  ...
  "Gamma Leonis   Algieba,10,17,20,6,130,,DS,2.6 and 3.8 separated by 4.3sec",
  "Gem Cluster,10,31,-57,58,1400,,OC,Red supergiant surrounded by blue stars. 8min across",
  "Gamma Volantis,7,9,-70,30,162,,DS,Double; 3.9 and 5.4 separated by 14 sec",
  "Gamma Velorum   Suhail al Muhlif,8,10,-47,20,2200,,DS,Double; 7.3 and 9.4  separated by 22 sec",
  "Upsilon Carinae,9,47,-65,4,1400,,DS, 3.0 and 6.0 separated by 5 sec",
  "Beta Muscae,12,46,-68,6,340,,DS,3.5 and 4.0 separated by 1.4 seconds",
  "Mu Crucis,12,55,-57,11,410,,DS,3.9 and 5.0 separated 35 seconds",
  "Alpha Circini,14,43,-64,59,54,,DS,3.2 and 8.5 sep 16 secs",
  "Theta Indi,21,20,-53,27,99,,DS,4.5 and 6.9 separated 7 seconds",
  "Delta Tucanae,22,27,-64,58,251,,DS,4.5 and 8.7 sep 7 seconds"
