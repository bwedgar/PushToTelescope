const dataText = ["47 Tucanae,0,24,-72,5,13000,,GC,30 thousand stars with a dense core which may contain a black hole. Second brightest globular cluster. Not part of the LMC. 12 myo.",
  ...
  "Theta Eridani,2,56,-40,30,120,,DS,3 + 4 9s 91°",
  "32 Eridani,3,55,-2,53,313,,DS,5 + 6 7s 348°",
  ...
  "Gamma Leonis   Algieba,10,17,20,6,130,,DS,2.6 + 3.8 4.3s",
  "Gem Cluster,10,31,-57,58,1400,,OC,Red supergiant surrounded by blue stars. 8min across",
  "Gamma Volantis,7,9,-70,30,162,,DS,3.9 + 5.4 14s 298°",
  "Gamma Velorum   Suhail al Muhlif,8,10,-47,20,2200,,DS,7.3 + 9.4 22s 221°",
  "Upsilon Carinae,9,47,-65,4,1400,,DS, 3.0 + 6.0 5s 128°",
  "Beta Muscae,12,46,-68,6,340,,DS,3.5 + 4.0 1.4s 37°",
  "Mu Crucis,12,55,-57,11,410,,DS,4 + 5 35s 15°",
  "Alpha Circini,14,43,-64,59,54,,DS,3 + 9 16s 227°",
  "Theta Indi,21,20,-53,27,99,,DS,5 + 7 7s 273°",
  "Delta Tucanae,22,27,-64,58,251,,DS,5 + 9 7s 281°",
  "Sigma Orionis,5,39,-2,35,1100,DS,8 + 3 0.2s 62°"
